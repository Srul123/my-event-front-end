...
export const addEventInvitedGuestsOwner = (eventOwner: EventOwner, token: string) => async (dispatch: (arg0: { type: any; payload: any; }) => void) => {
    let response;
    const headers = {
    ...
    try {
        ...
        console.error("Error from ownerActions action: addEventInvitedGuestsOwner ");
        console.error(e);
